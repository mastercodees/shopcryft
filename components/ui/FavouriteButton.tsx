    ...
    return (
        <>
            {!showProduct ? <Link href={"/wishlist"} className='group  relative'>
                ...
                <span className='absolute -top-1 -right-1 bg-shop_dark_green text-white h-3.5 w-3.5 rounded-full
            text-xs font-semibold flex item-center justify-center'>0</span>
            </Link> :
